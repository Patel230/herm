...
Run a shell command in the dev container (image: __CONTAINER_IMAGE__, project mounted at /workspace). Use for: running builds, tests, installs, and commands that aren't file reads. Output is truncated to 80 lines / 12KB (head+tail).
