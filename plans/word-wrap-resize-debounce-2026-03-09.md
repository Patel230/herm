...
- [x] 2b: Add a test that verifies debounce behavior: multiple rapid width changes should result in only one final render (or verify the timer reset logic). May need to extract the debounce logic into a testable helper.
